document.addEventListener("DOMContentLoaded", () => {
  const btn = document.getElementById("aboutTranslateBtn");
  const elements = Array.from(document.querySelectorAll("[data-about-translate]"));
  ...
  async function translateToRomanian() {
    try {
      ...
      setButton("Hide Translation");
      isRomanian = true;
    } catch (err) {
      console.error("About translation error:", err);
